        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
          <div className="flex items-center">
            ...
            <div className="ml-4 flex space-x-2">
              <Button variant="outline" size="sm" className="bg-[#1a0a24] border-[#3a1a44] hover:bg-[#2a1a34]">
                Packs
              </Button>
              <Button variant="outline" size="sm" className="bg-[#1a0a24] border-[#3a1a44] hover:bg-[#2a1a34]">
                My Collection
            ...
            >
              <div className="bg-[#1a0a24] rounded-xl overflow-hidden border border-[#3a1a44] transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 hover:border-pink-500/50 hover:scale-[1.02]">
                ...
                <div className="relative h-64 overflow-hidden">
                  {/* Main Cover Image */}
                  <div
                    className={`absolute inset-0 transition-opacity duration-500 ${hoveredPack === pack.id ? "opacity-0" : "opacity-100"}`}
                  >
                    <Image
                      ...
                      <div className="relative w-full h-full">
                        {pack.previewImages.map((img, index) => (
                          <div
                            ...
                            style={{
                              opacity: index === 0 ? 1 : 0,
                              animation: index === 0 ? "fadeInOut 6s infinite" : `fadeInOut 6s infinite ${index * 2}s`,
                            }}
                          >
                            <Image
                            ...
                            />
                            {!pack.isOwned && <div className="absolute inset-0 bg-black/20 backdrop-blur-[2px]"></div>}
                          </div>
                        ))}
                      </div>
                    </div>
